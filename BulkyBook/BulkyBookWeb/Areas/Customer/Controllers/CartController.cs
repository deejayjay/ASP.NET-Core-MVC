...
{
    [Area("Customer")]
    [Authorize] // Add at controller level to restric the access to the whole page
        ...
        public IActionResult SummaryPOST()
        {
            ...
            foreach (var cart in ShoppingCartVM.ListCart)
            {
                ...
                OrderDetail orderDetail = new()
                {
                    ...
                    // Using the navigation property instead so that the entire operation is OLTP
